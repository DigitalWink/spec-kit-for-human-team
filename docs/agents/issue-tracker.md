...
Issues and specs for this repo live as GitHub issues in [`DigitalWink/spec-kit-for-human-team`](https://github.com/DigitalWink/spec-kit-for-human-team). Use the `gh` CLI for all operations.
