...
Bump rationale: MAJOR — 8 obligations present in II. Test-Backed Change
  (NON-NEGOTIABLE) are absent after this run; 3 are added in its rewrite.
Principles added: (none)
Principles modified: II. Testing and verification (renamed from II. Test-Backed Change (NON-NEGOTIABLE))
...
**Version**: 2.0.0 | **Ratified**: 2026-06-19 | **Last Amended**: 2026-08-26
